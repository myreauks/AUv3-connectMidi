//
//  connectMidiMultipleExtensionAUProcessHelper.hpp
...
#include <vector>
#include "connectMidiMultipleExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(connectMidiMultipleExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    connectMidiMultipleExtensionDSPKernel& mKernel;
};
